...
public class PlayerController2 : MonoBehaviour
{
    ...
    private GameManager2 gameManager2; // Reference to the GameManager script
    ...
    void Update()
    {
        ...
        {
            if (!gameManager2.chatBox.isFocused) // Check if the chat input field is not focused
            {
    ...
    public void SetGameManager(GameManager2 manager)
    {
