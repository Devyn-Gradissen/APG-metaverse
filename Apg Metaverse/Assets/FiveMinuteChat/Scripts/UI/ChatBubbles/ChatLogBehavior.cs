...
namespace FiveMinuteChat.UI.ChatBubbles
{
    public class ChatLogBehavior : MonoBehaviour, IChatLogBehavior
    {
        ...
        private readonly Dictionary<Guid, ChatEntry> _chatEntries = new Dictionary<Guid, ChatEntry>();
        ...
        private void Activate()
        {
            ...
            {
                Logger.LogError($"{GetType().FullName}: No {nameof(ChatConnectionBehavior)} has been assigned to the Connection field. It must either be found as a parent of this GameObject or set explicitly via the Connection field on this behavior.");
            }
        }
